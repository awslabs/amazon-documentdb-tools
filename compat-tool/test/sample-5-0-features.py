...
result = col.aggregate([
                       ...
                       allowDiskUse = True)
print(result)                       
result = col.aggregate([ { "$project" : { "createDatePlus1": { "$dateAdd": { startDate: "$originalDate", unit: "day", amount: 1 }}}} ])
print(result)                       
result = col.aggregate([ { "$project" : { "createDatePlus1": { "$dateSubtract": { startDate: "$originalDate", unit: "day", amount: 1 }}}} ])
print(result)                       
