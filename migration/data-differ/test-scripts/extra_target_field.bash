...
mongoimport $SOURCE_URI -d $SOURCE_DB -c $SOURCE_COLL extra_target_field_source.json
mongoimport $TARGET_URI -d $TARGET_DB -c $TARGET_COLL extra_target_field_target.json
