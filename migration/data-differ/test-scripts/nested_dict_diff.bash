...
mongoimport $SOURCE_URI -d $SOURCE_DB -c $SOURCE_COLL nested_dict_diff_source.json
mongoimport $TARGET_URI -d $TARGET_DB -c $TARGET_COLL nested_dict_diff_target.json
