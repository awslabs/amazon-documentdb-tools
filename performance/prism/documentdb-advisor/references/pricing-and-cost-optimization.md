...
**IMPORTANT**: The tables below are the COMPLETE list of valid DocumentDB instance types. No other sizes exist. There is no "medium" for R5/R6G/R8G/R6GD and no "large" for R6GD. Do not extrapolate sizes from EC2 or RDS — DocumentDB has a more limited set.
